        ...
        do {
            ...
            switch (pilih) {
                ...
                if (dinilai != null) {
                    ...
                    String biner = stack.konversiDesimalKeBiner09(nilai);
                ...
                case 5:
                Mahasiswa09 terbawah = stack.terbawah();
                if (terbawah != null) {
                ...
                case 6:
                System.out.println("Jumlah tugas yang sudah dikumpulkan: " + stack.hitung());
                break;
